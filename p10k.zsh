...
() {
  ...
  # Strip benevity_ prefix (matches old aws_profile_short RPROMPT).
  typeset -g POWERLEVEL9K_AWS_CONTENT_EXPANSION='${${P9K_AWS_PROFILE#benevity_}//\%/%%}'
  ...
  # Format: date + time (DD.MM.YY HH:MM:SS), matching prior right-prompt look.
